...
class PydoopAvroRecordMaterializer extends RecordMaterializer<Text> {
  ...
  public PydoopAvroRecordMaterializer(
      RecordMaterializer<IndexedRecord> materializer) {
...
public class PydoopAvroReadSupport extends ReadSupport<Text> {
    ...
    public static void setRequestedProjection(Configuration configuration,
      ...
      AvroReadSupport.setRequestedProjection(
          configuration, requestedProjection);
    }
    ...
    @Override
    public RecordMaterializer<Text> prepareForRead(
