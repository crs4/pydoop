...
static PyMethodDef FsClass_methods[] = {
  ...
  {"get_working_directory", (PyCFunction) FsClass_get_working_directory,
   METH_NOARGS, "Get the current working directory for the given filesystem."},
  ...
  {"set_working_directory", (PyCFunction) FsClass_set_working_directory,
   METH_VARARGS, "Get the current working directory for the given filesystem."},
...
static PyMethodDef FileClass_methods[] = {
  {"close", (PyCFunction)FileClass_close, METH_NOARGS, "FIXME"},
  {"available", (PyCFunction) FileClass_available, METH_NOARGS, "FIXME"},
  {"mode", (PyCFunction)FileClass_mode, METH_NOARGS, "FIXME"},
  {"get_mode", (PyCFunction) FileClass_get_mode, METH_NOARGS,
   "Get the current working directory for the given filesystem."},
  {"write", (PyCFunction)FileClass_write, METH_VARARGS, "FIXME"},
  {"flush", (PyCFunction) FileClass_flush, METH_NOARGS, "FIXME"},
  {"read", (PyCFunction) FileClass_read, METH_VARARGS, "FIXME"},
  {"read_chunk", (PyCFunction) FileClass_read_chunk, METH_VARARGS, "FIXME"},
  {"pread", (PyCFunction) FileClass_pread, METH_VARARGS, "FIXME"},
  {"pread_chunk", (PyCFunction) FileClass_pread_chunk, METH_VARARGS, "FIXME"},
  {"seek", (PyCFunction) FileClass_seek, METH_VARARGS, "FIXME"},
  {"tell", (PyCFunction) FileClass_tell, METH_NOARGS, "FIXME"},
  {NULL}  /* Sentinel */
};
